...
local sets = {
    ['TP'] = {
        ...
        Ring1 = 'K\'ayres Ring',
        Ring2 = 'Rajas Ring',
        Back = { Name = 'Evasionist\'s Cape', Augment = { [1] = '"Embolden"+9', [2] = '"Dbl.Atk."+1', [3] = 'Enmity+4' } },
    ...
    ['Idle'] = {
        ...
        Ear1 = 'Bladeborn Earring',
        Ear2 = 'Steelflash Earring',
        Body = { Name = 'Futhark Coat', AugTrial=5226 },
        Hands = 'Meg. Gloves +1',
        Ring1 = { Name = 'Dark Ring', Augment = { [1] = 'Phys. dmg. taken -4%', [2] = 'Breath dmg. taken -3%' } },
        Ring2 = { Name = 'Dark Ring', Augment = 'Phys. dmg. taken -5%' },
        Back = { Name = 'Evasionist\'s Cape', Augment = { [1] = '"Embolden"+9', [2] = '"Dbl.Atk."+1', [3] = 'Enmity+4' } },
        Waist = 'Flume Belt',
    ...
    if(#args > 0)then
        if(#args == 1)then
            if(args[1]:any('tpmode'))then
                ...
                elseif(Settings.TP_Mode == 'Cap')then
                    Settings.TP_Mode = 'PDT';
                end
...
profile.HandleAbility = function()
    ...
    if(string.find(act.Name, 'Swipe') or string.find(act.Name, 'Lunge'))then
